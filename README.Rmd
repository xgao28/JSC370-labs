...
- compared to the adjusted R-squared value of the cubic spline model (0.0604), 
- indicating that the linear model explains more variance in the response variable.
- Also, the linear model has a larger F-statistic with a highly significant p-value.
